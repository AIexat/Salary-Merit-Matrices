...
- **Данные:** Реальные рыночные данные по состоянию на 1 мая 2025 года
  ...
  - Полная функциональная вертикаль (от Admin до Operations)
  - 2,921 функциональная группа
  - 383,000+ сотрудников
- **Методология:** Monte Carlo симуляция (10,000 итераций на группу = 350,520 тестовых сценариев)
...
1. **Первое систематическое исследование** точности aggregated distributions method на реальных рыночных данных (383K+ сотрудников, 2,921 группа, 350,520 симуляций)
